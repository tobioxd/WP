...
class DatePicker {
  ...
  render(date) {
    ...
    const noti = document.createElement("h3");
    noti.classList.add("noti");
    const notiId = "noti-" + this.id;
    noti.id = notiId;
    noti.appendChild(document.createTextNode("Selected date:"));
  ...
  generateDaysContent(table, date) {
    ...
    for (let day = 1; day < currMonthDays + 1; day++) {
      ...
      cell.onclick = () => {
        ...
        const selectedDateDisplay = document.querySelector("#noti-" + table.parentNode.id);
